...
class _VerifyEmailPageState extends State<VerifyEmailPage> {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8.h),
                    Text(
                      "A verification code has been sent to johndoe@gmail.com. Enter the code below to continue.",
                      style: TextStyle(
                        fontSize: 14.sp,
                    ...
                    Pinput(
                      ...
                      focusedPinTheme: PinTheme(
                        ...
                        decoration: BoxDecoration(
                          border:
                              Border.all(color: Color(0xFF5C1EDC), width: 1.5),
                          borderRadius: BorderRadius.circular(12),
                        ),
                      ),
  ...
  void _onVerifyPressed() {
    // Show loading modal
    OnboardingModals.showEmailVerifyingModal(context);

    // Simulate verification process
    Future.delayed(Duration(seconds: 2), () {
      Navigator.of(context).pop(); // Close loading modal
      OnboardingModals.showEmailVerifiedModal(context);
    });
  }
}
