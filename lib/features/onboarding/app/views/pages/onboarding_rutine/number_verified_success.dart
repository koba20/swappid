...
class NumberVerifiedSuccessPage extends StatelessWidget {
  static const route = '/number-verified-success';
  const NumberVerifiedSuccessPage({Key? key}) : super(key: key);
            ...
            child: Column(
              ...
              children: [
                ...
                SButton(
                  ...
                  onPressed: () {
                    Navigator.pushNamed(context, KYCSelectionPage.route);
                  },
                ),
              ],
            ),
